$(document).ready(function(){
    ...
    $('.btn-phone-submit').click(function(){
    	var _this = $(this);
    	var phone = _this.parent().prev('input[name="phone"]').val();
    	console.log(phone);
    	if (phone == '') {
    		alert('请填写手机号码');
    		return false;
	    ...
	    if(!_this.attr('data-disabled')){
	    	...
	    	var url = "http://yytoutiao.duoxiangweb.com/zhangyu/index.php?g=mobile&m=index&a=ajax_save_phone";
	    	var data = {
	    		"phone":phone,
	    		"from":"YD-百度HH"
	    	}
...
//红包弹窗
    ...
    /*$('.close-btn').click(function(){
    	$('.popup').addClass('fadeOut hide').removeClass('fadeIn');
    	setTimeout(function(){
    		$('.popup').removeClass('fadeOut hide').addClass('fadeIn');
    	},50000);
    });*/