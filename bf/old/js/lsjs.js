...
var LR_70bcb='BEBC9AC485464CF98C24473C1FE8CE23';var LR_isMobile = 0;
...
var LR_js_pm = 'd';
var LR_lng = 'cn';
var LR_f00b1=LR_70bcb.replace(/1/g,'3').replace(/0/g,'2');var LR_e31fd=LR_f00b1.replace(/4/g,'8').replace(/5/g,'3');var LR_CJJC=LR_e31fd.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&NJIL='+LR_CJJC;
