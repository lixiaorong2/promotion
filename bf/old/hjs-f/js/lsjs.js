var LR_57f25='35A7915B7060404AA0ECFB96B5EC55C3';var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_sysurl = 'https://pkt.zoosnet.net/';
var LiveReceptionCode_isonline = 1;
var LR_lng = 'cn';
var LR_imgurl = 'https://pkt.zoosnet.net/';
var LR_ssl = 0;
var LR_siteid = '99997384';
if(typeof(LR_showfloat)=='undefined')var LR_showfloat = 0;
LR_57f25=LR_57f25.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_js_pm = 'd';
var LR_isMobile = 0;
var LR_websiteid = 'PKT99997384';
LR_57f25=LR_57f25.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_EGMH=LR_57f25.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	LR_hasInstall=0;
	var LR_ivite_img='https://pkt.zoosnet.net/js/tj_blue/p.gif';
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&IEAF='+LR_EGMH;
