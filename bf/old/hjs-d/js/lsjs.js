var LR_03fec='DA242421143C47D4B7B7CDE7FE05B384';var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_siteid = '99997384';
var LiveReceptionCode_isonline = 1;
LR_03fec=((3+1).toString()+LR_03fec+(3*1).toString());var LR_sysurl = 'https://pkt.zoosnet.net/';
if(typeof(LR_showfloat)=='undefined')var LR_showfloat = 0;
var LR_imgurl = 'https://pkt.zoosnet.net/';
var LR_websiteid = 'PKT99997384';
var LR_js_pm = 'd';
LR_03fec=((3+2).toString()+LR_03fec+(3*2).toString());var LR_ssl = 0;
var LR_isMobile = 0;
var LR_lng = 'cn';
LR_03fec=((3+3).toString()+LR_03fec+(3*3).toString());var LR_JKLH=LR_03fec.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&CJIH='+LR_JKLH;
